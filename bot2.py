        ...
        if current_total_match_solo != last_total_match_solo or current_total_match_flex != last_total_match_flex:
            ...
            if not onoffbool:
                ...
                for winner in winners:
                    ...
                    # ====================  [미션]  ====================
                    # 시즌미션 : 난 이기는 판만 걸어
                    point_ref_mission = db.reference(f'승부예측/예측시즌/{current_predict_season}/예측포인트/{winner["name"]}')
            ...
            async def betrate_button_callback(interaction: discord.Interaction):
                ...
                async def select_callback(interaction: discord.Interaction):
                    ...
                    if item_num > 0:
                        ...
                        item_embed = discord.Embed(title=f"{item_name}", color=discord.Color.purple())
